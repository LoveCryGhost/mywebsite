...
class PasswordController extends Controller
{
    ...
    {
        return view('auth.password_reset.password_request');
    }
    ...
    public function sendResetLinkEmail(Request $request)
    {
        ...
        // 6. 将 Token 链接发送给用户
        Mail::send('auth.password_reset.reset_link', compact('token'), function ($message) use ($email) {
    ...
    public function showResetForm(Request $request)
    {
        ...
        return view('auth.password_reset.reset', compact('token'));
    }
