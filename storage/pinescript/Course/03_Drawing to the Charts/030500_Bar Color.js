...
//=========== [DA] Drawing & Alert ============================================
//##### Drawing
bgcolor(inside? color.new(color.blue, 80): na, title="bg Color", offset=-1, editable=true, show_last=100)
barcolor(inside? color.new(color.yellow, 0): na, title="bg Color", offset=-1, editable=true, show_last=100)
